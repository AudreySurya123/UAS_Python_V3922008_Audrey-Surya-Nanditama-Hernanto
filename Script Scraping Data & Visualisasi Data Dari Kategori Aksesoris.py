...
web_url = 'https://www.bukalapak.com/c/motor-471/aksesoris-motor?page=' # Menyimpan link web bukalapak yang akan discraping ke variabel.
...
csv_file = 'data_aksesoris.csv'  # Deklarasi nama file CSV untuk menyimpan data.
...
data = pd.read_csv("data_aksesoris.csv")
...
# Menambahkan judul.
plt.title("Histogram Aksesoris Berdasarkan Alamat")

# Menyimpan Histogram dalam format JPG dengan nama file 'Histogram_Aksesoris.jpg'.
plt.savefig('Histogram_Aksesoris.jpg', dpi=300, bbox_inches='tight')
...
# Menambahkan judul.
plt.title("Pie Chart Aksesoris Berdasarkan Alamat")

# Menyimpan Pie Chart dalam format JPG dengan nama file 'PieChart_Aksesoris.jpg'.
plt.savefig('PieChart_Aksesoris.jpg', dpi=300, bbox_inches='tight')
